...
const Home = () => {
    return (
        ...
        <div className='bg-gradient-to-r from-[#FFE6FD] to-[#E0F8F5] py-15'>
                <h2 className='text-4xl font-bold text-center '>Deal your <span className='text-primary'>Products</span> in a Smart way !</h2>
        ...
        <div className='text-center px-20 mt-4'>
            <input className='rounded-full  border py-1.5' type="search" name="search" id="" placeholder="Search products..." />
        </div>
